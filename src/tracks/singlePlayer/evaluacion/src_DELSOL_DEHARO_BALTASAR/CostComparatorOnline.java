...
// Compara dos NodoOnline en función del coste total, después del valor de g y
// por último del orden preestablecido de expansión
class CostComparatorOnline implements Comparator<NodoOnline> {
	public int compare (NodoOnline n1, NodoOnline n2) {
