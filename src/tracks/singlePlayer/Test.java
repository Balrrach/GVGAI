...
public class Test {
	...
	public static void main(String[] args) {
		...
		// String controlador = "TSI.AgenteCamel";
		String controlador;
		// controlador = "tracks.singlePlayer.myController.AgenteBFS";
		// ArcadeMachine.runOneGame(game, level1, visuals, controlador, recordActionsFile, seed, 0);
		// controlador = "tracks.singlePlayer.myController.AgenteDFS";
		// ArcadeMachine.runOneGame(game, level1, visuals, controlador, recordActionsFile, seed, 0);
		// controlador = "tracks.singlePlayer.myController.AgenteAStar";
		// ArcadeMachine.runOneGame(game, level1, visuals, controlador, recordActionsFile, seed, 0);
		// controlador = "tracks.singlePlayer.myController.AgenteIDAStar";
		// ArcadeMachine.runOneGame(game, level1, visuals, controlador, recordActionsFile, seed, 0);
		controlador = "tracks.singlePlayer.myController.AgenteRTAStar";
		ArcadeMachine.runOneGame(game, level1, visuals, controlador, recordActionsFile, seed, 0);
